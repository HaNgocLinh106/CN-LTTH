...
@Component({
  ...
  templateUrl: './add-or-edit-task-test-model.component.html',
  styleUrls: ['./add-or-edit-task-test-model.component.css']
})
export class AddOrEditTaskTestModelComponent extends AppComponentBase implements OnInit {
