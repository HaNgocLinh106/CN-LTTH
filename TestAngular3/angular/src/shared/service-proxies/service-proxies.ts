...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAll(): Observable<ListResultDtoOfEmployeeListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfEmployeeListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfEmployeeListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<ListResultDtoOfEmployeeListDto> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfEmployeeListDto.fromJS(resultData200) : new ListResultDtoOfEmployeeListDto();
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Observable.of<ListResultDtoOfEmployeeListDto>(<any>null);
    }

    /**
     * @return Success
     */
    createEmployee(input: CreateEmployeeInput): Observable<EmployeeListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<EmployeeListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<EmployeeListDto>><any>Observable.throw(response_);
        });
    }

    protected processCreateEmployee(response: Response): Observable<EmployeeListDto> {
        const status = response.status; 
        ...
        return Observable.of<EmployeeListDto>(<any>null);
    }
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<EmployeeListDetailDto[]>><any>Observable.throw(e);
                }
            } else
                return <Observable<EmployeeListDetailDto[]>><any>Observable.throw(response_);
        });
    }

    protected processGetListEmployee(response: Response): Observable<EmployeeListDetailDto[]> {
        const status = response.status; 
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                result200 = [];
                for (let item of resultData200)
                    result200.push(EmployeeListDetailDto.fromJS(item));
            }
            return Observable.of(result200);
        } else if (status !== 200 && status !== 204) {
            const _responseText = response.text();
        ...
        return Observable.of<EmployeeListDetailDto[]>(<any>null);
    }

    /**
     * @return Success
     */
    getEmployee(id: number): Observable<EmployeeListDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetEmployee?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetEmployee(response: Response): Observable<EmployeeListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    updateEmployee(input: UpdateEmployeeInput): Observable<void> {
    ...
    protected processUpdateEmployee(response: Response): Observable<void> {
        const status = response.status; 
     ...
     * @return Success
     */
    deleteEmployee(employeeIds: number[]): Observable<void> {
    ...
    protected processDeleteEmployee(response: Response): Observable<void> {
        const status = response.status; 
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getAll(state: State2): Observable<ListResultDtoOfTaskListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<ListResultDtoOfTaskListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ListResultDtoOfTaskListDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: Response): Observable<ListResultDtoOfTaskListDto> {
        const status = response.status; 
        ...
        return Observable.of<ListResultDtoOfTaskListDto>(<any>null);
    }

    /**
     * @return Success
     */
    create(input: CreateTaskInput): Observable<TaskListDto> {
        ...
        return this.http.request(url_, options_).flatMap((response_) => {
            ...
            if (response_ instanceof Response) {
                try {
                    ...
                    return <Observable<TaskListDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<TaskListDto>><any>Observable.throw(response_);
        });
    }

    protected processCreate(response: Response): Observable<TaskListDto> {
        const status = response.status; 
        ...
        return Observable.of<TaskListDto>(<any>null);
    }

    /**
     * @return Success
     */
    getTask(id: number): Observable<TaskListDto> {
        let url_ = this.baseUrl + "/api/services/app/Task/GetTask?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetTask(response: Response): Observable<TaskListDto> {
        const status = response.status; 
     ...
     * @return Success
     */
    update(input: UpdateTaskInput): Observable<void> {
...
export class EmployeeListDetailDto implements IEmployeeListDetailDto {
    ...
    constructor(data?: IEmployeeListDetailDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            this.taskComplete = data["taskComplete"];
            this.age = data["age"];
        }
    }

    static fromJS(data: any): EmployeeListDetailDto {
        let result = new EmployeeListDetailDto();
        result.init(data);
        return result;
    }
...
export interface IEmployeeListDetailDto {
    id: number;
    birthDate: moment.Moment;
    name: string;
    taskPending: number;
...
export enum CreateTaskInputState {
    _0 = 0, 
    _1 = 1, 
}
