...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAll(): Observable<EmployeeListDtoListResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EmployeeListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<EmployeeListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<EmployeeListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EmployeeListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<EmployeeListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createEmployee(body: CreateEmployeeInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    getEmployee(id: number | undefined): Observable<EmployeeListDto> {
     ...
     * @return Success
     */
    updateEmployee(body: UpdateEmployeeInput | undefined): Observable<void> {
...
export class TaskServiceProxy {
     ...
     * @return Success
     */
    getAll(state: TaskState | undefined): Observable<TaskListDtoListResultDto> {
     ...
     * @return Success
     */
    create(body: CreateTaskInput | undefined): Observable<TaskListDto> {
     ...
     * @return Success
     */
    getTask(id: number | undefined): Observable<TaskListDto> {
    ...
    protected processGetTask(response: HttpResponseBase): Observable<TaskListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: UpdateTaskInput | undefined): Observable<void> {
...
export class EmployeeListDtoListResultDto implements IEmployeeListDtoListResultDto {
    items: EmployeeListDto[] | undefined;

    constructor(data?: IEmployeeListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): EmployeeListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new EmployeeListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): EmployeeListDtoListResultDto {
        const json = this.toJSON();
        let result = new EmployeeListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IEmployeeListDtoListResultDto {
    items: EmployeeListDto[] | undefined;
}
