...
namespace TestAngular.Migrations
{
    ...
    [Migration("20210630043158_Added-AssignedEmployeeId-To-Task")]
    partial class AddedAssignedEmployeeIdToTask
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestAngular.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TestAngular.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TestAngular.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TestAngular.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TestAngular.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TestAngular.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Tasks.Task", b =>
                {
                    b.HasOne("TestAngular.Employees.Employee", "AssignedEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("TestAngular.Authorization.Roles.Role", b =>
                {
                    b.HasOne("TestAngular.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("TestAngular.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("TestAngular.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
